...
public class R147 {
    ...
    public R147(String label, double price, String category, boolean hasExpiration, int stock) {
        this.label = label;
        this.price = price;
    ...
    public R147(String label, double price, int stock) {
        this.label = label;
        this.price = price;
        category = "misc";
        hasExpiration = false;
    ...
    public R147(String label, double price, String category) {
        this.label = label;
        this.price = price;
...
class MainR147 {
    public static void main(String[] args) {
        R147 print1 = new R147("Eggs", 3, "Produce", true, 10);
        System.out.println(print1.label+" " + print1.price+" " + print1.category+" " + print1.hasExpiration+" " + print1.stock);

        R147 print2 = new R147("Paper Towels", 2,24);
        System.out.println(print2.label+" " + print2.price+" " + print2.category+" " + print2.hasExpiration+" " + print2.stock);

        R147 print3 = new R147("Paper Towels", 2, "default");
        System.out.println(print3.label+" " + print3.price+" " + print3.category+" " + print3.hasExpiration+" " + print3.stock);
    }
